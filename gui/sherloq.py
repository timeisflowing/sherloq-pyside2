...
from PySide2.QtGui import QKeySequence, QIcon, QActionEvent
from PySide2.QtWidgets import QApplication, QMainWindow, QMdiArea, QMdiSubWindow, QDockWidget, QMessageBox
